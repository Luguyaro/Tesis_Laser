...
def detectar_objeto_y_mover():
    ...
    while True:
        ...
        if best_box:
            ...
            if abs(error_y) > DEADZONE and not moving_servo.is_set() and (frame_count % 5 == 0):
                ...
                print(f"🎯 Frame: {frame_count} | Error Y: {error_y:+} px | PWM: {pulso_actual} µs")
